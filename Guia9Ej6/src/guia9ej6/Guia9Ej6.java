...
es un arreglo de tipo String de dimensión 5 (cinco), donde se alojarán los nombres de cada
...
ingresar los alumnos que asisten a las clases. Nosotros nos encargaremos
de almacenar esta información en un arreglo e iterar con un bucle, solicitando
...
Curso. En este método invocamos al método cargarAlumnos() para asignarle valor 
al atributo alumnos
...
public class Guia9Ej6 {
    ...
    curso1.crearCurso();
    double gananciaSemanal = curso1.calcularGananciaSemanal();
