...
letra (NIF). Los atributos serán el número de DNI (entero largo) y la letra (String o char) que le corresponde.
...
public class Guia8EJjex2 {

 public static void main(String[] args) {
    NIFService nifService = new NIFService();

   
    NIF miNIF = nifService.crearNif();

  
    nifService.mostrar(miNIF);
}
 }