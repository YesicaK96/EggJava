 ...
 */
package guia9ej6.pkg1;

import guia9ej6.pkg1.Entidad.Curso;
import java.util.Scanner;


public class Guia9ej61 {

  
public static void main(String[] args) {
    Scanner scanner = new Scanner(System.in);
    
    Curso curso = new Curso(); // Crear instancia de la clase Curso
    
    curso.crearCurso(scanner); // Cargar información del curso
    
    curso.calcularGananciaSemanal(); // Calcular ganancia semanal
    
    curso.mostrarCurso(); // Mostrar información del curso
}
}
