...
privados numero1 y numero2. A continuación, se deben crear los siguientes métodos:
...
Método dividir(): primero valida que no se haga una división 
por cero, si fuera a pasar una división por cero, el método devuelve
0 y se le informa al usuario el error se le informa al usuario. 
Si no, se hace la división y se devuelve el resultado al main.
 */
package guia7ej3;

import guia7ej3.Operaciones.Operaciones;
...
public class Guia7ej3 {
   ...
   Operaciones  si = new operaciones();
        ...
        si = sumar();
        Operaciones restar = null;
        si = restar;
        Operaciones multiplicar = null;
        si = multiplicar;
        si = dividir();
    ...
    private static Operaciones sumar() {
    ...
    private static Operaciones dividir() {
        throw new UnsupportedOperationException("Not supported yet.");
    }
